...
public class SmsService {
     ...
     */
    private boolean send(String phone, String templateCode, String templateParam) {
        //设置超时时间-可自行调整
...
//        String templateParam = "{\"verificationCode\":\"" + verificationCode + "\"}";
//        send(phone, "SMS_211499635", templateParam);
